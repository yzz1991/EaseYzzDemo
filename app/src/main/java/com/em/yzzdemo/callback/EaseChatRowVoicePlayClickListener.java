...
public class EaseChatRowVoicePlayClickListener implements View.OnClickListener {
	...
	public EaseChatRowVoicePlayClickListener(EMMessage message, ImageView v, ChatMessageAdapter adapter, Activity context) {
	...
	public void stopPlayVoice() {
		...
		if (message.direct() == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(R.mipmap.ease_chatfrom_voice_playing);
		} else {
			voiceIconView.setImageResource(R.mipmap.ease_chatto_voice_playing);
		}
		// stop play voice
		if (mediaPlayer != null) {
			mediaPlayer.stop();
